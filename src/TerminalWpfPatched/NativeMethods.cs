...
#pragma warning disable SA1600 // Elements should be documented
    internal static class NativeMethods
    {
        ...
        [DllImport("Microsoft.Terminal.Control.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall, PreserveSig = true)]
        [return: MarshalAs(UnmanagedType.I1)]
        public static extern bool TerminalCopySelectionToClipboard(IntPtr terminal);

        [DllImport("Microsoft.Terminal.Control.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall, PreserveSig = true)]
        public static extern void TerminalPasteFromClipboard(IntPtr terminal);

        [DllImport("Microsoft.Terminal.Control.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall, PreserveSig = true)]
        [return: MarshalAs(UnmanagedType.I1)]
        public static extern bool TerminalClipboardContainsText();
